...
mod tests {
  ...
  "justification": {
    ...
    "votes_ancestries": []
        ...
        assert_eq!(
            justification_rsp.justification.commit.target_number,
            2075796
        );
        assert_eq!(
            justification_rsp.justification.commit.target_hash,
            H256(hex!(
                "fe0652f4564fe2b55fcd41edac2846da7eec9aae335db8149f456a9b784141ab"
            ))
        );
        assert_eq!(justification_rsp.justification.commit.precommits.len(), 2);
        assert_eq!(
            justification_rsp.justification.commit.precommits[0]
                .id
                .to_string(),
            "5CExo2wmED2c3genFUdY9kkeSBHsfAcUbDTBVDpTZ8M26xyg"
        );
        assert_eq!(
            justification_rsp.justification.commit.precommits[1]
                .id
                .to_string(),
        ...
        assert_eq!(ToHexExt::encode_hex(&justification_rsp.justification.commit.precommits[1].signature), "da13946cf5ed0ded1a0d385bcfa4ee2edda7dade7569dc9dff34fdf520f97b4468c2ea77cb7c6cdc5350a70b7d0a28d8512b62e3c20f392d80dad1f18fa67400");
        assert_eq!(justification_rsp.justification.votes_ancestries.len(), 0);
    }
}
